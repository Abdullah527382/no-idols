export default function StatCard({ icon: Icon, label, value, sub, accent = 'ember' }) {
  const accentClass = accent === 'blood' ? 'text-blood-light bg-blood/15' : accent === 'brass' ? 'text-brass bg-brass/15' : 'text-ember bg-ember/15'
